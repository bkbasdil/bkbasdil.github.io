...
Research Experience
======
* [**Endogenous Industrial Policy and Dynamic Export Competitiveness**](/research/industrial-policy/)
  * Developed a dynamic game-theoretic model of industrial policy under strategic international rivalry.
  * Modeled endogenous sectoral targeting with stochastic policy implementation and intersectoral trade-offs via a zero-budget constraint.
  * Characterized policy choices and export specialization as a Markov Perfect Equilibrium driven by relative cost structures, state capacity, and intertemporal incentives.

* [**Industrial Location in Turkey, 1927-2020: Endowments, Market Access, and Policies**](/research/industrial-location/)
  * Co-Author — Gunes Asik, Alpay Filiztekin, Ulas Karakoc (2025)
